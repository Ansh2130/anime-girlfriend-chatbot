...
API_URL = "https://api-inference.huggingface.co/models/gpt2"  # Use GPT-2 for chatbot

API_TOKEN = "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"  # Replace with your API token
